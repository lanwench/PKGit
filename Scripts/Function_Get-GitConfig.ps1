...
Set-Alias -Name gcc -Value Get-GitConfig -Confirm:$false -Force
Set-Alias -Name Get-PKGitConfig -Value Get-GitConfig -Confirm:$false -Force -Description "For consistency with other functions in PKGit module"